    ...
    <Box sx={{ width: '100%'}} height="100vh" style={gradeintBackground}>
      <Box sx={{display: 'flex', width: '100%', height: '100%', justifyContent: 'center', alignItems: 'center'}}>
        <Box sx={{width: 300, height: 650, p: '10px', borderRadius: '10px' }} style={transparentBackground}>
          ...
          <br/> <br/>
          <Typography sx={{ textAlign: 'center' }} variant="h5">Order Freelancer</Typography> <br/>
          <form onSubmit={handleSubmit}>
            <input style={inputStyle} id="title" type="text" name="title" value="Freelancer Name" disabled/> <br/>
